...
set env CURRENT_NETLIST ./results/synthesis/ZeroToFiveCounter.v
...
set env SAVE_DEF ./results/floorplan/ZeroToFiveCounter.def
set env SAVE_NETLIST ./out.v
set env SAVE_ODB ./results/floorplan/ZeroToFiveCounter.odb
