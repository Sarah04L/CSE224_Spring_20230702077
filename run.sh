...
export CURRENT_NETLIST='./results/synthesis/ZeroToFiveCounter.v';
export CURRENT_ODB='./tmp/floorplan/5-tapcell.odb';
export CURRENT_POWERED_NETLIST='0';
export DESIGN_NAME='ZeroToFiveCounter';
...
export FP_PDN_VOFFSET='2.530';
export FP_PDN_VPITCH='5.060';
...
export SAVE_DEF='./results/floorplan/ZeroToFiveCounter.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./results/floorplan/ZeroToFiveCounter.odb';
