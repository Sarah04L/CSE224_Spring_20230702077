...
export CURRENT_NETLIST='./results/synthesis/lab6_cpu.v';
export CURRENT_ODB='./tmp/floorplan/5-tapcell.odb';
export CURRENT_POWERED_NETLIST='0';
export DESIGN_NAME='lab6_cpu';
...
export FP_PDN_VOFFSET='1.090';
export FP_PDN_VPITCH='2.185';
...
export PACKAGED_SCRIPT_4='openlane/designs/lab6_cpu/src/lab6_cpu.sdc';
export PNR_SDC_FILE='openlane/designs/lab6_cpu/src/lab6_cpu.sdc';
export PROCESS_CORNER='nom';
export SAVE_DEF='./results/floorplan/lab6_cpu.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./results/floorplan/lab6_cpu.odb';
export SCRIPTS_DIR='openlane/scripts';
export SIGNOFF_SDC_FILE='openlane/designs/lab6_cpu/src/lab6_cpu.sdc';
